...
var rectBackgroundY = 15;
function initButton() {
    var scaleObj = { "zoomScale": 1, "zoomTargetScale": 1 };
    constant.sequenceButtonView.append("rect").attr("width", constant.svgWidth).attr("height", rectBackgroundY).style({
        "fill": "#ffffff"
    });
    constant.sequenceButtonView.append("rect").attr("width", constant.svgWidth).attr("height", 2 * constant.buttonVerticalSpace + constant.buttonHeight).attr("y", rectBackgroundY).style({
        "fill": "#f7f7f7"
    });
